[![Build Status](https://travis-ci.org/mdluo/craco-less.svg?branch=master)](https://travis-ci.org/mdluo/craco-less)
[![Coverage Status](https://coveralls.io/repos/github/mdluo/craco-less/badge.svg?branch=master)](https://coveralls.io/github/mdluo/craco-less?branch=master)
...
you should use the [`craco-antd`](https://github.com/mdluo/craco-antd) plugin.
